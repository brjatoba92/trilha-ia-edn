def processo_training_logs(file_name):
    """
    Aqui cria-se um docstring
    """
...
if __name__ == "__main__":
    ...
    try:
        total_time, average_precision, batch_loss, max_batch, min_batch = processo_training_logs(file_name)
        ...
        print(f'Lotes com perda maior que 0.5: {batch_loss}')
